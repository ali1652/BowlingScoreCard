...
const FourPlayerScoreCard = ({navigation}) => {
...
let datee = new Date().toLocaleDateString();
    ...
    return (
        ...
        <TextInput 
            ...
            value={team1Player3}
            onChangeText={(text) =>{
                setTeam1Player3((text));  
            }}
            />
        <Text style={styles.textLabelHeadingsPlayers}>Player 3</Text>
        ...
        <TextInput 
            ...
            value={team1Player4}
            onChangeText={(text) =>{
                setTeam1Player4((text));  
            }}
            />
        <Text style={styles.textLabelHeadingsPlayers}>Player 4</Text>
...
export default FourPlayerScoreCard;